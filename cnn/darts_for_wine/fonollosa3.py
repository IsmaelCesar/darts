...
def resetv():
    ...
    start_value = int(6400/samp)#int(5500/samp)
    step = int(1400/5) #oldstep 7000  int(500/samp)
    end_value = int(19000/5)+1  #19000 -> 19289 samples size of B5_GMe_F050_R1.txt file old  end_value int(11500/samp) + 1
