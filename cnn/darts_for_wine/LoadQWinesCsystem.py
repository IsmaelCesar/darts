...
def resetv():
    ...
    start_value = int(474/samp) #Defines the first window, old_start_value:1730 int(1730/samp)
...
args.save = '{}-{}-LoadQWinesCsystem-WithPerclassAcc'.format(args.save, time.strftime("%Y%m%d-%H%M%S"))
