...
parser.add_argument('--batch_size', type=int, default=1, help='batch size')#Batchsize default is 64
...
parser.add_argument('--init_channels', type=int, default=3, help='num of init channels')#default is 16
